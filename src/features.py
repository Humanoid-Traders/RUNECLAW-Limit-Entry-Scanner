...
ACHR NETEASE QUBT WDC OPENAI ANTHROPIC SKHY""".split())
# v0.9.50 -- SKHY added: the venue lists SK Hynix under TWO bases (SKHYNIXUSDT
# and SKHYUSDT, both in the public contracts feed 2026-07-13); only the long
# form was allowlisted, so SKHYUSDT fell through to crypto/BTC. Same company,
# both must route to equities. Found by the 2026-07-13 venue census.
